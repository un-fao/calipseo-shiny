...
LEFT JOIN dt_fishing_trip_activity_gears as fag ON fa.ID = fag.DT_FISHING_ACTIVITY_ID 
LEFT JOIN cl_fish_gears as g ON fag.CL_REF_GEAR_ID = g.ID 
...
LEFT JOIN jt_fish_fishing_unit_segment_mapping as fufs ON fufs.CL_FISH_FISHING_UNIT_ID = ft.CL_FISH_FISHING_UNIT_ID 
