SELECT 'fisher' AS Category, Salutation,FIRST_NAME,MIDDLE_NAME,SUFFIX_NAME,NAME, GenderCode, Gender, DOB, IndividualNumber, Fisher_Id,Owner,Captain,License 
FROM(
...
ent.NAME, gend.CODE AS GenderCode, gend.I18n_DEFAULT AS Gender,ind.DATE_OF_BIRTH AS DOB,edulevel.I18n_DEFAULT AS Edulevel,
...
SELECT 'nonfisher' AS Category, Salutation,FIRST_NAME,MIDDLE_NAME,SUFFIX_NAME,NAME, GenderCode, Gender, DOB, IndividualNumber, Fisher_Id,Owner,Captain,License 
FROM(
SELECT distinct (ind.REG_ENTITY_ID) AS IndividualNumber, salu.I18n_DEFAULT as Salutation, ind.FIRST_NAME, ind.MIDDLE_NAME, ind.SUFFIX_NAME, 
ent.NAME, gend.CODE as GenderCode, gend.I18n_DEFAULT AS Gender,ind.DATE_OF_BIRTH AS DOB,edulevel.I18n_DEFAULT AS Edulevel,
IF(regv.REG_ENTITY_OWNER_ID IS NULL, 0,1) AS Owner, IF(regv.REG_ENTITY_CAPTAIN_ID IS NULL, 0,1) AS Captain, IF(ls.PERMIT_NUMBER IS NULL, 0,1) AS License,
