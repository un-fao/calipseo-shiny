...
LEFT JOIN jt_fish_species_fish_processing_type as rspft ON rspft.CL_REF_SPECIES_ID = fas.CL_REF_SPECIES_ID AND rspft.CL_FISH_PROCESSING_TYPE_ID = fas.CL_FISH_PROCESSING_TYPE_ID 
