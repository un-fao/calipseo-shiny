...
FROM dt_fishing_trips AS ft 
LEFT JOIN dt_fishing_trip_activities AS fa ON fa.DT_FISHING_TRIP_ID = ft.ID 
LEFT JOIN dt_fishing_trip_activity_species AS fas ON fas.DT_FISHING_ACTIVITY_ID = fa.ID 
