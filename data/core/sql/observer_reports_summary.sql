SELECT 
 ...
 CASE WHEN EXISTS (SELECT 1 FROM dt_fishing_trips ft2 WHERE ft2.REG_VESSEL_ID = ft.REG_VESSEL_ID AND ft2.DATE_FROM = ft.DATE_FROM AND ft2.DATE_TO = ft.DATE_TO AND ft2.CL_FISH_FISHING_TRIP_TYPE_ID = 1) THEN 1 ELSE 0 END AS logbook_linked, 
