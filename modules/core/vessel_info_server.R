#vessel_info_server
vessel_info_server <- function(id, parent.session, lang = NULL, pool, reloader) {
 ...
 moduleServer(id, function(input, output, session) {
  ...
  observe({
    ...
    if(!is.null(vesselId)){
      ...
      #fishing trips chart
      trip_gantt_server(id="fishing_trips_chart", lang = lang, pool, vessel_stat_type=NULL, vesselId=vesselId,mode="light")
    ...
    INFO("vessel-info: END")
    DEBUG_MODULE_PROCESSING_TIME("Vessel-info", MODULE_START_TIME, MODULE_END_TIME)
