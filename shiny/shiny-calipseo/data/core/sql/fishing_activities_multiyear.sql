...
fz.CODE as gr_f_area_id, fz.NAME as fishing_zone,
ls.CODE as arrivalport, ls.ID as bch_id, ls.NAME as landing_site,
g.CODE as f_mthd_id, g.NAME as fishing_gear,
