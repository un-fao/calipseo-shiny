...
ind.REG_ENTITY_ID AS individualNumber,fr.CODE AS FSH_CODE,fr.I18n_DEFAULT AS FSH_ROLE FROM reg_entity_individuals AS ind 
...
LEFT JOIN reg_entity_individual_role_fishery AS entfr ON ind.ID = entfr.REG_ENTITY_INDIVIDUAL_ID 
