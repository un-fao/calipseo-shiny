...
individual_breakdown_server <- function(id, pool) {
  ...
  moduleServer(id, function(input, output, session) {  
    ...
    updateSelectizeInput(session, "filter_individual_roles_gender", choices = fishing_roles(), options = list(create = TRUE, placeholder = 'All'))
    updateSelectizeInput(session, "filter_individual_roles_edu", choices = fishing_roles(), options = list(create = TRUE, placeholder = 'All'))
    
    fsh_role_label <- reactive({return(paste(input$filter_individual_roles_gender))})
    ...
    observe({
      ...
      output$individual_gender <- renderPlotly({
        ...
        individual_breakdown <- ind_roles_filter(individual_breakdown,input$filter_individual_roles_gender,grouping = TRUE)
      ...
      age_gender <- accessIndividualDetails(pool)[,c("Gender","DOB","FSH_ROLE")]
      age_gender <- ind_roles_filter(age_gender,input$filter_individual_roles_gender,grouping = FALSE)
      age_gender <- age_gender[,c("Gender","DOB")]
      ...
      male_df <- age_gender[age_gender$Gender=='Male',]
      male_df$Age <- as.numeric(male_df$Age)
      female_df <-  age_gender[age_gender$Gender=='Female',]
      ...
      output$individual_edulevel <- renderPlotly({
        ...
        individual_breakdown_edulevel <- ind_roles_filter(individual_breakdown_edulevel,input$filter_individual_roles_edu)
      ...
      output$individual_edulevel_male <- renderPlotly({
        ...
        individual_breakdown_edulevel_male <- ind_roles_filter(individual_breakdown_edulevel_male,input$filter_individual_roles_edu)
      ...
      output$individual_edulevel_female <- renderPlotly({
        ...
        individual_breakdown_edulevel_female <- ind_roles_filter(individual_breakdown_edulevel_female,input$filter_individual_roles_edu)
