              ...
              shinyWidgets::verticalTabsetPanel(
                shinyWidgets::verticalTabPanel(i18n("VERTICALTABPANEL_INDIVIDUAL_BREAKDOWN_GENDER"),box_height='70px',
                                               div(h4(i18n("INDIVIDUAL_BREAKDOWN_TITLE_GENDER")),
                                                   selectizeInput(ns("filter_individual_roles_gender"),label = i18n("SELECT_INDIVIDUAL_ROLES"),choices =NULL,multiple = TRUE, width = '40%'),
                                                   ...
                                                   box(width = 12, height = 480, title = sprintf(i18n("BREAKDOWN_INDIVIDUAL_TITLE_PYRAMID"), appConfig$country_profile$data$NAME), status = "primary", solidHeader= TRUE,
                                                       fluidRow(column(width = 4,textOutput(ns("total_mean_age"))),
                                                                column(width = 4,textOutput(ns("male_mean_age"))),
                                                                column(width = 4,textOutput(ns("female_mean_age")))),
                                                       plotlyOutput(ns("individual_age_gender"))))),
                shinyWidgets::verticalTabPanel(i18n("VERTICALTABPANEL_INDIVIDUAL_BREAKDOWN_EDUCATION"),box_height='70px',
                                               div(h4(i18n("INDIVIDUAL_BREAKDOWN_TITLE_EDUCATION")),
                                                   selectizeInput(ns("filter_individual_roles_edu"),label = i18n("SELECT_INDIVIDUAL_ROLES"),choices =NULL,multiple = TRUE, width = '40%'),
