  ...
  tabItem(tabName = "vessel_qa",
          ...
          div(class='row',style = "margin:0px;", id='vertical-panels-vessel-qa',
              shinyWidgets::verticalTabsetPanel(
                ...
                shinyWidgets::verticalTabPanel(i18n("VERTICALTABPANEL_VESSEL_QA_ACTIVITY"),box_height='70px',box(width = 12, height = 480, title = i18n("VESSEL_QA_TITLE_ACTIVITY"),DT::dataTableOutput(ns("vessel_activity"))))))
  )
